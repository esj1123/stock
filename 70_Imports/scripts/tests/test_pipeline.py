...
from portfolio_model import apply_expense_fx_rates, apply_holdings_snapshot_asof_register, apply_income_fx_rates, build_fx_rate_requirements, build_income_summary, build_monthly_cashflow_summary, build_performance_history, build_performance_summary, build_portfolio, build_portfolio_outputs, generate_reports, has_filled_section, load_fx_rates, resolve_fx_rate
...
def test_generate_reports_applies_user_confirmed_holdings_snapshot_asof_register(tmp_path: Path):
    ...
    pd.DataFrame([
        {"source_file": "synthetic_source.xlsx", "source_file_type": "holdings", "account_type": "ISA", "market": "KR", "snapshot_date": ""},
    ]).to_csv(processed / "source_file_index.csv", index=False)
    pd.DataFrame([
        {
            "source_file_type": "holdings",
