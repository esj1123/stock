...
from portfolio_model import build_income_summary, build_performance_summary, build_portfolio, build_portfolio_outputs, generate_reports
...
def test_cashflow_dashboard_surfaces_income_expense_and_fx_summaries(tmp_path: Path):
    ...
    assert "| interest | KRW | 1000.0 | 1000.0 | 0.0 | 0.0 | 1000.0 | 1000.0 | 1 | 0 | 0 | available |" in content
    assert "| dividend | USD | 12.34 |  | 0.0 |  | 12.34 |  | 1 | 1 | 1 | fx_missing |" in content
