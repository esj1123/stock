...
from portfolio_model import build_income_summary, build_monthly_cashflow_summary, build_performance_history, build_performance_summary, build_portfolio, build_portfolio_outputs, generate_reports
...
def test_cashflow_dashboard_surfaces_income_expense_and_fx_summaries(tmp_path: Path):
    ...
    assert "| interest | KRW | 1,000 | 1,000 | 0 | 0 | 1,000 | 1,000 | 1 | 0 | 0 | available |" in content
    assert "| dividend | USD | 12.34 USD |  | 0 USD |  | 12.34 USD |  | 1 | 1 | 1 | fx_missing |" in content
