...
from qa_checker import QA_EXCEPTION_ROLLUP_COLUMNS, build_qa_exception_rollup, run_qa
...
def synthetic_rec_ex_01_rollup_rows() -> pd.DataFrame:
    base = {
        ...
        "suggested_fix": "Keep official KRW totals review-gated until same-date provenance exists.",
    }
    return pd.DataFrame([
...
def test_qa_exception_dashboard_keeps_row_level_exception_details_available():
    ...
    assert "Keep official KRW totals review-gated until same-date provenance exists." in content
